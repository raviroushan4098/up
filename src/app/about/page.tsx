      ...
      <AnimatePresence mode="wait">
        {loading || !cms ? (
          ...
          >
            ...
            <section className="bg-gradient-to-r from-neutral-100 to-neutral-200 dark:from-neutral-800 dark:to-neutral-900 py-20 relative overflow-hidden">
              <div className="container mx-auto px-4 text-center max-w-3xl relative z-10 flex flex-col items-center">
                <Skeleton className="h-6 w-32 rounded-full mb-4" />
                <div className="space-y-3 w-full flex flex-col items-center">
                  <Skeleton className="h-12 w-3/4 rounded-xl" />
                  <Skeleton className="h-12 w-1/2 rounded-xl" />
                </div>
                <Skeleton className="h-16 w-5/6 rounded-lg mt-5" />
                <div className="w-16 h-0.5 bg-neutral-300 mx-auto mt-6" />
              </div>
            </section>
            ...
            <section className="w-full overflow-hidden">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-0 items-stretch">
                <div className="flex flex-col justify-center bg-white p-8 sm:p-12 md:p-16 lg:p-24 space-y-4">
