      ...
      <section className="bg-gradient-soft py-14">
        <div className="container mx-auto px-4 text-center max-w-3xl">
          ...
          <h1 className="font-display font-extrabold text-4xl sm:text-5xl text-primary">
            We're here to <span className="text-gradient-saffron">help</span>
          </h1>
            ...
            <CardContent className="p-6 sm:p-8">
              ...
              <form onSubmit={handleSubmit} className="mt-6 grid sm:grid-cols-2 gap-4">
                <div className="space-y-1.5">
                  ...
                  <Input required placeholder="Aarav Sharma" />
                </div>
                <div className="space-y-1.5">
                  <Label>Mobile</Label>
                ...
                <div className="space-y-1.5 sm:col-span-2">
                  <Label>Message</Label>
                  <Textarea required rows={5} placeholder="Type your message..." />
                </div>
                <div className="sm:col-span-2">
                  <Button
                    type="submit"
                    size="lg"
                    className="w-full bg-gradient-saffron text-primary font-semibold"
                  >
